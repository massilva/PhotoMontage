...
jQuery(function()
{
	...
	// Links
        jQuery('a').click(function(e) {
            //Verificando se o elmento está na lista do menu
            if(isMenuChildren($(this)))
            {
                ...
                {
                    var pos = Math.max(article.parent().offset().top - _nav.height(), 0);
                    e.preventDefault();
...
function isMenuChildren(obj){
    return ($("#nav").has(obj).length) > 0 ? true : false;
}